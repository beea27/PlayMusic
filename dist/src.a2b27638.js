...
var currentSong = 1;
var songsList = [];
var songTitle = document.querySelector("h1");
var uploadFileLabel = document.querySelector("label");
var uploadFileInput = document.querySelector("input");
var player = document.querySelector("audio");
var playButton = document.querySelector("#play");
var stopButton = document.querySelector("#stop");
var previousSongButton = document.querySelector("#prev");
var nextSongButton = document.querySelector("#next");
...
function playSong() {
  var songUrl = URL.createObjectURL(songsList[currentSong - 1]);
